...
export function AreasPage() {
  ...
  return (
    <>
      <Seo
        title="مناطق الخدمة في الكويت | كينج كلين King Clean"
        description="كينج كلين تقدم خدمات تنظيف في مختلف محافظات ومناطق الكويت، تشمل العاصمة، حولي، الفروانية، الأحمدي، الجهراء ومبارك الكبير."
        canonicalPath="/areas"
        keywords={[
          "مناطق خدمة كينج كلين",
          "شركة تنظيف في الكويت",
          "تنظيف في حولي",
          "تنظيف في الفروانية",
          "تنظيف في الأحمدي",
          "تنظيف في الجهراء",
          "تنظيف في مبارك الكبير",
          "تنظيف العاصمة الكويت",
        ]}
      />
      <PageHero
        title="مناطق الخدمة"
